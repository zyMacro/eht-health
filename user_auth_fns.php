...
// see if somebody is logged in and notify them if not
  if (!(isset($_SESSION['valid_user'])))  {
      // echo "hello,".$_SESSION['valid_user']."先生/女士".".<br />";
...
// return the new password or false on failure
  ...
  // $new_password='1234';                              //Attention , what 's the best way to set new_password?
  ...
  $conn = db_connect();
  $result = $conn->query("update login
...
// notify the user that their password has been changed
    ...
    if (!$result) {
      ...
      $from = "From: kevin211993@sjtu.edu.cn \r\n";
