...
?>
  ...
  <body>
  <img src="title.png" alt="eht logo" border="0"
       align="left" valign="bottom" height="55" width="57" />
  <h1>health outcome </h1>
  <hr />
<?php
  if($title) {
...
?>
  ...
  <li>See your Physical examination result table!</li>
...
?>
  ...
  <?php
  $color = "#cccccc";
  echo "<tr bgcolor=\"".$color."\"><td><strong>eht health</strong></td>";
...
<a href="health_form.php">health</a> &nbsp;|&nbsp;
<?php
